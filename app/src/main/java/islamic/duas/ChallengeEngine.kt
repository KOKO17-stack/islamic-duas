...
class ChallengeEngine {
    ...
    private val tracks = listOf(
        ChallengeTrack(
            "prayer_30", "30 دن — نماز کی پابندی", "نماز وقت پر پڑھنے کا چیلنج",
            "🕌", "اس 30 دن کے چیلنج میں ہر روز اپنی پانچوں نمازیں وقت پر پڑھیں۔ ہر نماز کے بعد اذکار کرنا نہ بھولیں۔",
            (1..30).map { day ->
                ChallengeDay(
                    ...
                    action = "آج کی 5 نمازیں وقت پر پڑھیں",
                    scoreReward = if (day % 7 == 0) 50 else 10
                )
            }
        ),
        ChallengeTrack(
            "azkar_30", "30 دن — اذکار کا معمول", "صبح و شام کے اذکار",
            "📿", "ہر روز صبح اور شام کے اذکار پڑھیں۔ یہ آپ کو اللہ کی حفاظت میں رکھیں گے۔",
            (1..30).map { day ->
                ChallengeDay(
                    day, "دن $day — اذکار",
                    if (day <= 7) "صبح کے اذکار پر توجہ دیں — کم از کم 5 اذکار"
        ...
        ChallengeTrack(
            "quran_30", "30 دن — قرآن سے تعلق", "روزانہ قرآن پڑھنے کا چیلنج",
            "📖", "ہر روز کم از کم 10 منٹ قرآن پڑھیں۔ سمجھ کر پڑھیں اور غور کریں۔",
            (1..30).map { day ->
                ChallengeDay(
                    day, "دن $day — تلاوت",
                    if (day <= 7) "آج 10 منٹ قرآن پڑھیں — کوئی بھی سورۃ"
                    else if (day <= 14) "آج 15 منٹ قرآن پڑھیں — ترجمہ دیکھ کر"
                    else if (day <= 21) "آج 20 منٹ قرآن پڑھیں — ایک پارہ مکمل کریں"
                    else "آج 25 منٹ قرآن پڑھیں — غور و تدبر کے ساتھ",
        ...
        ChallengeTrack(
            "sadaqah_30", "30 دن — صدقہ کا سلسلہ", "روزانہ صدقہ کا چیلنج",
            "🤝", "ہر روز کچھ نہ کچھ صدقہ دیں — چاہے تھوڑا ہی سہی۔ صدقہ رزق میں برکت لاتا ہے۔",
            (1..30).map { day ->
                ChallengeDay(
                    day, "دن $day — صدقہ",
                    if (day <= 7) "آج کچھ صدقہ دیں — چاہے 10 روپے ہی سہی"
        ...
        ChallengeTrack(
            "tahajjud_30", "30 دن — تہجد کا سفر", "رات کی نماز کا چیلنج",
            "🌃", "ہر رات تہجد کی نماز پڑھیں — چاہے 2 رکعت ہی سہی۔ رات کا وقت دعا کی قبولیت کا ہے۔",
            (1..30).map { day ->
                ChallengeDay(
                    day, "دن $day — تہجد",
                    if (day <= 7) "آج رات 2 رکعت تہجد پڑھیں — فجر سے پہلے"
                    else if (day <= 14) "آج 4 رکعت تہجد پڑھیں — لمبی سجدے کریں"
                    else if (day <= 21) "آج 6 رکعت تہجد پڑھیں — خوب دعا کریں"
        ...
        ChallengeTrack(
            "fasting_30", "30 دن — روزے کا چیلنج", "پیر اور جمعرات کے روزے",
